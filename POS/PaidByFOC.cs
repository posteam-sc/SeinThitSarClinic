...
namespace POS
{
    public partial class PaidByFOC : Form
    {
        ...
        private void PaidByFOC_Load(object sender, EventArgs e)
        {
            ...
            System.Data.Objects.ObjectResult<String> Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, Type, ExtraTax + Tax, 0 ,totalCost, 0, null, CustomerId, MCDiscount, BDDiscount, MemberTypeId, MCDiscountPercent, false, "", IsWholeSale, CustomerTypeId, RoomId,0);
            ...
            if (Type == 4 || Type == 6)
            {
                ...
                //ReportParameter TotalAmount = new ReportParameter("TotalAmount", insertedTransaction.TotalAmount.ToString());  //Edity By ZMH
